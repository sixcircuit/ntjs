...
(function(){
   ...
   waiter.prototype._try_finish = function(deferred){
      ...
      (function finish_wait(){
         ...
         if(no_callback++ > (50 * 1001)){ throw (new Error("error: tamejs: no callback to call back after " + no_callback - 1 + " nextTicks. this is probably an error.\n")); }
